...
from gen_model.data import get_feat_distributions, normalize_data, impute_data, split_data, str2num, num2str, sample_cat
from gen_model.data_generation.generator import Generator, transform_features
...
def main(args=None):
    ...
    parameters2save = {'seed': [best_seeds[0]], 'params': [str(args['param_comb'][0]['latent_dim']) + '_' + str(args['param_comb'][0]['hidden_size'])]}
