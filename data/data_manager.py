...
def force_missing_at_random(df, p_missing):
    ...
    for i in range(n_nan_values):
        while True:
            ...
            if not pd.isnull(arr[random_row, random_col]):
...
class DataManager:
    ...
    def postprocess_rec_data(self, rec_info, params, seed):
        # TODO: obtain samples, denormalize them, save as .csv
        pass
    ...
    def postprocess_gen_data(self, gen_info, params, seed):
        ...
        # TODO: maybe BGM didn't converge, so no samples where generated!!
    ...
    # TODO: save data as raw_df (transform types to originals)
